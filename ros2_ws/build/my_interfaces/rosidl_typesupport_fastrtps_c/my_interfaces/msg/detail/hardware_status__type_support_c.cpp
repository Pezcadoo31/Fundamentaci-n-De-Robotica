...
#include "rosidl_runtime_c/string.h"  // debug_status
#include "rosidl_runtime_c/string_functions.h"  // debug_status
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: debug_status
  {
    const rosidl_runtime_c__String * str = &ros_message->debug_status;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: debug_status
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->debug_status.data) {
      rosidl_runtime_c__String__init(&ros_message->debug_status);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->debug_status,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'debug_status'\n");
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += padding +
    ...
    (ros_message->debug_status.size + 1);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    is_plain =
      (
      offsetof(DataType, debug_status) +
      last_member_size
      ) == ret_val;
  }
