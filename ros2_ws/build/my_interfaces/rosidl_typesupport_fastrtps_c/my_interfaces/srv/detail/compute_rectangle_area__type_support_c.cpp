...
#include "my_interfaces/srv/detail/compute_rectangle_area__rosidl_typesupport_fastrtps_c.h"
...
using _ComputeRectangleArea_Request__ros_msg_type = my_interfaces__srv__ComputeRectangleArea_Request;
...
size_t get_serialized_size_my_interfaces__srv__ComputeRectangleArea_Request(
  const void * untyped_ros_message,
...
static uint32_t _ComputeRectangleArea_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_interfaces__srv__ComputeRectangleArea_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_interfaces
size_t max_serialized_size_my_interfaces__srv__ComputeRectangleArea_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_interfaces__srv__ComputeRectangleArea_Request;
    is_plain =
      (
...
static size_t _ComputeRectangleArea_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_interfaces__srv__ComputeRectangleArea_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_interfaces, srv, ComputeRectangleArea_Request)() {
...
using _ComputeRectangleArea_Response__ros_msg_type = my_interfaces__srv__ComputeRectangleArea_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_interfaces
size_t get_serialized_size_my_interfaces__srv__ComputeRectangleArea_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ComputeRectangleArea_Response__ros_msg_type * ros_message = static_cast<const _ComputeRectangleArea_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_interfaces__srv__ComputeRectangleArea_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_interfaces
size_t max_serialized_size_my_interfaces__srv__ComputeRectangleArea_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_interfaces__srv__ComputeRectangleArea_Response;
    is_plain =
      (
...
static size_t _ComputeRectangleArea_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_interfaces__srv__ComputeRectangleArea_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_interfaces, srv, ComputeRectangleArea_Response)() {
...
// already included above
// #include "my_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "my_interfaces/srv/compute_rectangle_area.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_interfaces, srv, ComputeRectangleArea)() {
