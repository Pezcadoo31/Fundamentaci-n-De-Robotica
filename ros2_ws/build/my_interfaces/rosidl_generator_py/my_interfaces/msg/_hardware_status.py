...
class HardwareStatus(metaclass=Metaclass_HardwareStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.debug_status = kwargs.get('debug_status', str())
    ...
    def __eq__(self, other):
        ...
        if self.are_motors_ready != other.are_motors_ready:
            return False
        if self.debug_status != other.debug_status:
            return False
        return True
    ...
    def debug_status(self):
        """Message field 'debug_status'."""
        return self._debug_status

    @debug_status.setter
    def debug_status(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'debug_status' field must be of type 'str'"
        self._debug_status = value
