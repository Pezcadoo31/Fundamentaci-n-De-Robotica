...
#include "my_interfaces/srv/detail/compute_rectangle_area__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_interfaces::srv::ComputeRectangleArea_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_interfaces::srv::ComputeRectangleArea_Request & ros_message)
{
  // Member: length
  cdr >> ros_message.length;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_interfaces::srv::ComputeRectangleArea_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_interfaces::srv::ComputeRectangleArea_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_interfaces::srv::ComputeRectangleArea_Request *>(
    untyped_ros_message);
...
{
  return &my_interfaces::srv::typesupport_fastrtps_cpp::_ComputeRectangleArea_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_interfaces, srv, ComputeRectangleArea_Request)() {
  return &my_interfaces::srv::typesupport_fastrtps_cpp::_ComputeRectangleArea_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_interfaces
cdr_serialize(
  const my_interfaces::srv::ComputeRectangleArea_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: area
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_interfaces::srv::ComputeRectangleArea_Response & ros_message)
{
  // Member: area
  cdr >> ros_message.area;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_interfaces::srv::ComputeRectangleArea_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_interfaces::srv::ComputeRectangleArea_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_interfaces::srv::ComputeRectangleArea_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &my_interfaces::srv::typesupport_fastrtps_cpp::_ComputeRectangleArea_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_interfaces, srv, ComputeRectangleArea_Response)() {
  return &my_interfaces::srv::typesupport_fastrtps_cpp::_ComputeRectangleArea_Response__handle;
}
...
{
  return &my_interfaces::srv::typesupport_fastrtps_cpp::_ComputeRectangleArea__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_interfaces, srv, ComputeRectangleArea)() {
  return &my_interfaces::srv::typesupport_fastrtps_cpp::_ComputeRectangleArea__handle;
}
